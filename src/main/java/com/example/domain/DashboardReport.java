...
public class DashboardReport {
    ...
    public DashboardReport(Date dimensionDate, Double unfilledImpression, Double impression, Double revenue, Double adRequest, Double adClicks, Double responses) {
